...
{	
	...
	ADMUX = 0b01100000;			//Bit 7 en 6 zorgen voor de ADC output.  Bit 5 is ADLAR die op 1 wordt gezet. Bit 4 tot en met 0 is voor het kiezen van pinF0 tot en met pinF7.
